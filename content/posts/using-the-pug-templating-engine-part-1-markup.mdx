...
excerpt: >-
  If you’re about to launch a web-based project, whether it’s for a small or
  large business, the following are the team members you simply can’t do
  without.
published: true
feauredImage: >-
  https://res.cloudinary.com/dcrgbfjfu/image/upload/v1644109220/iamtimsmith/using-the-pug-templating-engine-part-1-markup_hm37pg.jpg
---
...
If you have any questions or run into issues, you can find me on Twitter [@iam\_timsmith](https://www.twitter.com/iam_timsmith).
