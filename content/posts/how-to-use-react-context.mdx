...
published: true
feauredImage: >-
  http://res.cloudinary.com/dcrgbfjfu/image/upload/v1687669984/iamtimsmith/how-to-use-react-context_xfnwbh.jpg
tags:
  - basics
  - react
---
...
In my last post, I talked about [many of the different hooks that are available in React](/blog/getting-started-with-react-hooks). They have become the more common way to do things because they allow you to write most things as functional components.
