...
excerpt: >-
  If you're anything like me, the concept of state was confusing at first. In
  this tutorial, we'll learn how to use state and props in a react js
  application.
published: true
feauredImage: >-
  https://res.cloudinary.com/dcrgbfjfu/image/upload/v1644109217/iamtimsmith/this-state-how-to-use-state-in-react_frmrl7.png
---
...
<gif src="https://media.giphy.com/media/20KLYSIhq35V4EpVlC/giphy.mp4" caption="&#x22;What now?&#x22; - David Rose" width={300} />

I'm glad you asked. That brings us to the next section:

## Accessing State from the Render Method

Using state inside of our render method is pretty easy. Like *SUPER* easy. Can you guess how to do it without me telling you? I'll give you a few minutes.
...
<gif src="https://media.giphy.com/media/d2Z9QYzA2aidiWn6/giphy.mp4" caption="Awesome!" />
...
<gif src="https://media.giphy.com/media/3owzW5c1tPq63MPmWk/giphy.mp4" caption="Modifying data on a page in real-time can sound complicated" />
