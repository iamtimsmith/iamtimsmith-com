...
<gif src="https://media.giphy.com/media/1xpC9NtXaMlzsjmpxF/giphy.mp4" caption="Redux has been a reliable state management tool for years" />
...
<gif src="https://media.giphy.com/media/xUySTwRa249DIKvxEA/giphy.mp4" caption="What's next?" />
...
In the reducer I created, I used SET\_NAME as a type. This isn't too difficult to remember, but as I add more state and functionality it can get cumbersome to remember all of the possible action types. Because of this, many developers will create an object which holds the action types. An example of this object is below:
...
You can find me on Twitter at [@iam\_timsmith](https://www.twitter.com/iam_timsmith).
