...
excerpt: >-
  By learning a few commands can open a new world of functionality as a
  developer. Today I'm going to cover some of those basic commands to get you
  going.
published: true
feauredImage: >-
  https://res.cloudinary.com/dcrgbfjfu/image/upload/v1644109216/iamtimsmith/getting-started-with-the-linux-cli_kehqmj.jpg
tags:
  - workflow
---
...
<gif src="https://media.giphy.com/media/NhBH9RHZdpk4g/giphy.mp4" caption="Ferris Bueller changing his absent days in a command line interface." />
...
Let me know if you're using these or other commands in the terminal. You can reach me on twitter at [@iam\_timsmith](https://www.twitter.com/iam_timsmith).
