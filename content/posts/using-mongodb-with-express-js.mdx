...
excerpt: >-
  MongoDB is a nosql database that is growing in popularity. In this post, I'll
  show you how you can use it in your next Express application.
published: true
feauredImage: >-
  https://res.cloudinary.com/dcrgbfjfu/image/upload/v1644109221/iamtimsmith/using-mongodb-with-express-js_ml3don.jpg
tags:
  - express
  - mongodb
---
...
<gif src="https://media.giphy.com/media/XHGAZo1d0vlSsWXEZP/giphy.mp4" caption="Whatever you think is best" width={300} />
...
<gif src="https://media.giphy.com/media/s3d5ugcxFDApG/giphy.mp4" width={250} caption="Dwight is not impressed." />
...
2. Using MongoDB with an Express.js project
