...
excerpt: >-
  In this post, I'll teach you how using a kanban workflow when finding a job
  can help keep you organized throughout the application process.
published: true
feauredImage: >-
  https://res.cloudinary.com/dcrgbfjfu/image/upload/v1644109218/iamtimsmith/finding-a-job-using-kanban-workflow_q2ps0v.jpg
---
...
<gif src="https://media.giphy.com/media/r056JQBFkE8QE/giphy.mp4" caption="&#x22;Are you ready for this jelly?&#x22; - Moss, I.T. Crowd" />
...
![What your finished board should look like](https://res.cloudinary.com/dcrgbfjfu/image/upload/v1644109224/iamtimsmith/trello-board-setup_bno6qm.jpg "What your finished board should look like.")
...
![A card in the openings column](https://res.cloudinary.com/dcrgbfjfu/image/upload/v1644109224/iamtimsmith/card-in-opening_ntpjsb.jpg "A card in the openings column.")
...
Have thoughts or questions? Feel free to reach out to me on Twitter [@iam\_timsmith](https://www.twitter.com/iam_timsmith).
