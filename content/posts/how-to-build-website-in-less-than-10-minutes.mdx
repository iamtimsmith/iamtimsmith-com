...
excerpt: >-
  I will teach you how to build a website in less than 10 minutes using
  WordPress so you can get your site up and running with a custom theme and
  plugins.
published: true
feauredImage: >-
  https://res.cloudinary.com/dcrgbfjfu/image/upload/v1644109203/iamtimsmith/how-to-build-website-in-less-than-10-minutes_y8hnoy.jpg
---
...
![The WordPress logo on a rocket illustration.](https://res.cloudinary.com/dcrgbfjfu/image/upload/v1644109221/iamtimsmith/wordpress_xdiph2.png "The WordPress logo on a rocket illustration.")
...
![Installing WordPress through a cPanel interface.](https://res.cloudinary.com/dcrgbfjfu/image/upload/v1644109222/iamtimsmith/hostgator_jm4brc.png "Installing WordPress through a cPanel interface.")
...
![Select the domain for installation. This will be the address for your website.](https://res.cloudinary.com/dcrgbfjfu/image/upload/v1644109224/iamtimsmith/install_qhvr6h.png "Select the domain for installation. This will be the address for your website.")![Select the domain for installation. This will be the address for your website.]()
...
![Choose settings for your WordPress site.](https://res.cloudinary.com/dcrgbfjfu/image/upload/v1644109223/iamtimsmith/settings_upincu.png "Choose settings for your WordPress site.")![Choose settings for your WordPress site.]()
...
![Congratulations! Your installation is complete!](https://res.cloudinary.com/dcrgbfjfu/image/upload/v1644109223/iamtimsmith/details_r4vfjx.png "Congratulations! Your installation is complete!")![Congratulations! Your installation is complete!]()
...
![Now that your site is set up, login to Wordpress.](https://res.cloudinary.com/dcrgbfjfu/image/upload/v1644109224/iamtimsmith/login_rdhtej.png "Now that your site is set up, login to Wordpress.")![Now that your site is set up, login to Wordpress.]()
...
![You can customize your logo, menus, and other settings through the WordPress Customizer.](https://res.cloudinary.com/dcrgbfjfu/image/upload/v1644109216/iamtimsmith/customizer_f6r6ch.png)![You can customize your logo, menus, and other settings through the WordPress Customizer.]()
...
![You can change the appearance of your site by changing themes.](https://res.cloudinary.com/dcrgbfjfu/image/upload/v1644109219/iamtimsmith/theme_k0wk1r.png "You can change the appearance of your site by changing themes.")
...
![Don't see the theme you're looking for? You can add themes as well.](https://res.cloudinary.com/dcrgbfjfu/image/upload/v1644109219/iamtimsmith/add_themes_pyewls.png "Don't see the theme you're looking for? You can add themes as well.")
...
![You can add as many pages as you need. Pages should be pages on your site which have static information (About Us, Contact, Privacy Policy, etc).](https://res.cloudinary.com/dcrgbfjfu/image/upload/v1644109222/iamtimsmith/add_pages_nvoadu.png "You can add as many pages as you need. Pages should be pages on your site which have static information (About Us, Contact, Privacy Policy, etc).")
...
![Adding Posts to your website](https://res.cloudinary.com/dcrgbfjfu/image/upload/v1644109222/iamtimsmith/add_posts_fgnwa3.png "Adding Posts to your website")
...
![You can also us a drag-and-drop editor to change menus](https://res.cloudinary.com/dcrgbfjfu/image/upload/v1644109223/iamtimsmith/menu_yajzya.png "You can also us a drag-and-drop editor to change menus")
...
![How To Build A Website In Less Than 10 Minutes](https://res.cloudinary.com/dcrgbfjfu/image/upload/v1644109216/iamtimsmith/pinterest_dlpzrz.jpg)
