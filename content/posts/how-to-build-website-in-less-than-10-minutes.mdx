...
![Select the domain for installation. This will be the address for your website.](https://res.cloudinary.com/dcrgbfjfu/image/upload/v1644109224/iamtimsmith/install_qhvr6h.png "Select the domain for installation. This will be the address for your website.")
...
![Choose settings for your WordPress site.](https://res.cloudinary.com/dcrgbfjfu/image/upload/v1644109223/iamtimsmith/settings_upincu.png "Choose settings for your WordPress site.")
...
![Congratulations! Your installation is complete!](https://res.cloudinary.com/dcrgbfjfu/image/upload/v1644109223/iamtimsmith/details_r4vfjx.png "Congratulations! Your installation is complete!")
...
![Now that your site is set up, login to Wordpress.](https://res.cloudinary.com/dcrgbfjfu/image/upload/v1644109224/iamtimsmith/login_rdhtej.png "Now that your site is set up, login to Wordpress.")
...
![You can customize your logo, menus, and other settings through the WordPress Customizer.](https://res.cloudinary.com/dcrgbfjfu/image/upload/v1644109216/iamtimsmith/customizer_f6r6ch.png)
