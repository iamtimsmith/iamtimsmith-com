...
excerpt: >-
  In the last post, we covered setting up WordPress for use with Gatsby. Today
  we will cover how to pull the data from WordPress into Gatsby and build pages.
published: true
feauredImage: >-
  https://res.cloudinary.com/dcrgbfjfu/image/upload/v1644109211/iamtimsmith/how-to-build-a-blog-with-wordpress-and-gatsby-part-2_j09gqk.jpg
---
...
<gif src="https://media.giphy.com/media/sDcfxFDozb3bO/giphy.mp4" caption="Shut up and take my money! - Fry" />
...
<gif src="https://media.giphy.com/media/eb3WAhXzlUAFi/giphy.mp4" caption="&#x22;Get on with it!&#x22; - Tim the Enchanter" />
...
![Initial appearance of the Gatsby js starter](https://res.cloudinary.com/dcrgbfjfu/image/upload/v1644109223/iamtimsmith/gatsby2-1_b6fty8.png "Initial appearance of the Gatsby js starter")
...
![GraphQL query tests](https://res.cloudinary.com/dcrgbfjfu/image/upload/v1644109218/iamtimsmith/gatsby2-2_aongne.png "GraphQL query tests")

You may notice that there are several drilldowns inside of the `acf` field. This is saying "hey, look for the acf field called feat\_img and get the local, optimized versions of these images so we can use them". Gatsby also provides fragments which means inside of gatsby we could just put `...GatsbyImageSharpSizes` instead of drilling down so far and gatsby will know what to do with it.
...
<gif src="https://media.giphy.com/media/t3Mzdx0SA3Eis/giphy.mp4" caption="Jim Halpert gives a fist pump in excitment!" />
...
![See a list of pages on the development 404 page](https://res.cloudinary.com/dcrgbfjfu/image/upload/v1644109223/iamtimsmith/gatsby2-3_x3akze.png "See a list of pages on the development 404 page")
...
![The completed Blog Post Page](https://res.cloudinary.com/dcrgbfjfu/image/upload/v1687493255/iamtimsmith/gatsby2-4_gdseos.png "The completed Blog Post Page")

## Wrapping up Blog Posts

We're about half-way done with the actual Gatsby js build. In this post we covered how to import blog posts from WordPress into our Gatsby js application and create pages automatically for each post. Honestly, this is the hardest part about making sites in Gatsby. If you're still keeping up, great job! If you're struggling, don't be too hard on yourself. This stuff is hard. If you need to, you can reach out to me on twitter [@iam\_timsmith](https://www.twitter.com/iam_timsmith) and I'll be happy to help you.

<gif src="https://media.giphy.com/media/g9582DNuQppxC/giphy.mp4" caption="Obligatory Great Gatsby gif" />
