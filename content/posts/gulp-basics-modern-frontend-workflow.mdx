...
With a few lines of code for configuration, you can run a command in your terminal and have the sass files compiled using Node.js! If you want to support a wide array of browsers, you could also configure Gulp to add browser prefixes to any css code that needs them for maximum browser compatibility.
...
task("sass", function (done) {
  src("scss/**/*.scss").pipe(sass()).pipe(dest("dist/css"));
  done();
});
```
...
<Gif
  src="https://media.giphy.com/media/MrFNWzMrSgVFK/giphy.mp4"
  caption="R.I.P. Internet Explorer 11"
/>
...
<Gif
  src="https://media.giphy.com/media/lRRjGTRlFwmQYFmmpU/giphy.mp4"
  caption="&#x22;Knowing is half the battle&#x22; - G.I. Joe"
/>
