...
excerpt: >-
  We are going to build a task app that also filters the list based on a search
  query in real time. Sound complicated? It's not as complicated as you may
  think, so let's dig in!
published: true
feauredImage: >-
  https://res.cloudinary.com/dcrgbfjfu/image/upload/v1644109215/iamtimsmith/lets-build-a-search-bar-in-react_gdqdte.jpg
tags:
  - react
---
...
![Add packages to our project](https://res.cloudinary.com/dcrgbfjfu/image/upload/v1644109209/iamtimsmith/packages_snpdip.jpg "Add packages to our project")![Add packages to our project]()
...
<gif src="https://media.giphy.com/media/vohOR29F78sGk/giphy.mp4" caption="Users still need to be able to delete items." />
...
<gif src="https://media.tenor.com/videos/1c0f33f884ddedac7cacd0d5def58234/mp4" caption="&#x22;Whoop-dee-doo, Basil. What does it all mean?&#x22; - Austin Powers" width={550} />
...
<gif src="https://media.tenor.com/videos/481c9d9f53f8551e2c68598f847fd9a7/mp4" caption="&#x22;Did you ever thing that maybe there's more to life than being really, really, really ridiculously good looking?&#x22; - Derek Zoolander" width={500} />
