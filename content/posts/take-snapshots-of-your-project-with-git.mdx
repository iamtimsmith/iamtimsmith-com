...
excerpt: >-
  Git is a tool which allows you to take "snapshots" of your project. I'm going
  to show you how to get started with git so you can improve your worklow.
published: true
feauredImage: >-
  https://res.cloudinary.com/dcrgbfjfu/image/upload/v1644109217/iamtimsmith/take-snapshots-of-your-project-with-git_xdtf3c.jpg
---
...
![Kip from Napoleon Dynamite saying "I'm using git, so I guess things are getting pretty serious."](https://res.cloudinary.com/dcrgbfjfu/image/upload/v1644109224/iamtimsmith/napoleon-meme_uvkszw.jpg "I'm using git, so you could say it's getting pretty serious")![I'm using git, so you could say it's getting pretty serious](https://res.cloudinary.com/dcrgbfjfu/image/upload/v1644109224/iamtimsmith/napoleon-meme_uvkszw.jpg "I'm using git, so you could say it's getting pretty serious")
...
<gif src="https://media.giphy.com/media/kRmglZUDvDG/giphy.mp4" caption="Which one should you choose?" />
...
<gif src="https://media.giphy.com/media/zlLydol7ndM7C/giphy.mp4" caption="Rex stoping on a TV remote to change the channel" />
...
If you have any questions or run into problems, feel free to reach out to me on Twitter at [@iam\_timsmith](https://www.twitter.com/iam_timsmith).
