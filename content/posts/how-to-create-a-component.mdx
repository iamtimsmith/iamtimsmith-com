...
excerpt: >-
  Components are an essential part of any React application. In this post, we'll
  be learning how to create components to do whatever we want.
published: true
tags:
  - react
---
...
Also, I'd love to see the things you've built with React so show me [@iam\_timsmith](https://www.twitter.com/iam_timsmith) on Twitter!
