...
published: true
feauredImage: >-
  https://res.cloudinary.com/dcrgbfjfu/image/upload/v1644109210/iamtimsmith/creating-a-basic-server-with-express-js_w8abev.jpg
---
...
2. [Using MongoDB with an Express.js project](/blog/using-mongodb-with-express-js)
