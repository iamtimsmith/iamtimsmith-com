...
excerpt: >-
  In the third part of this series about WordPress and Gatsby js, we will be
  creating pages using templates and components using data from WordPress.
published: true
feauredImage: >-
  https://res.cloudinary.com/dcrgbfjfu/image/upload/v1644109211/iamtimsmith/how-to-build-a-blog-with-wordpress-and-gatsby-part-3_d4vwn6.jpg
---
...
![See a list of available pages by visiting the 404 page](https://res.cloudinary.com/dcrgbfjfu/image/upload/v1644109222/iamtimsmith/gatsby3-1_uwjb5m.png "See a list of available pages by visiting the 404 page.")
...
<gif src="https://media.giphy.com/media/zcCGBRQshGdt6/giphy.mp4" caption="... That was easy" />
...
![Finished blog home page](https://res.cloudinary.com/dcrgbfjfu/image/upload/v1644109214/iamtimsmith/gatsby3-2_gzdsan.png "The finished blog home page.")
...
<gif src="https://media.giphy.com/media/qLWdMYX1NYF2g/giphy.mp4" caption="&#x22;So close...&#x22; - Jim Halpert" />
...
![Graphql query to get siteName from WordPress](https://res.cloudinary.com/dcrgbfjfu/image/upload/v1644109224/iamtimsmith/gatsby3-3_b0ezin.png "Graphql query to get siteName from WordPress")
...
![Our Gatsby js blog after updating the header component](https://res.cloudinary.com/dcrgbfjfu/image/upload/v1687449613/iamtimsmith/gatsby3-4_eb0bgw.png "Our Gatsby js blog after updating the header component")
...
![GraphiQL query to get menu items from WordPress](https://res.cloudinary.com/dcrgbfjfu/image/upload/v1644109223/iamtimsmith/gatsby3-5_s2nz0m.png "GraphiQL query to get menu items from WordPress")
...
![Blog after adding menu to header](https://res.cloudinary.com/dcrgbfjfu/image/upload/v1644109223/iamtimsmith/gatsby3-6_vkef44.png "Blog after adding menu to header")
...
If you have any thoughts or questions, you can find me on twitter at [@iam\_timsmith](https://twitter.com/iam_timsmith)!
