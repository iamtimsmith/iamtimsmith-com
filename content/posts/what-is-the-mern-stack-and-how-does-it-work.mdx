...
<gif src="https://media.giphy.com/media/tO5ddHjpXB6lG/giphy.mp4" caption="Kuzco and Pacha don't know about the MERN stack." />
...
<gif src="https://media.giphy.com/media/5wFkqt6A8R4qAqGIFQ/giphy.mp4" caption="I need to know details!" />
...
<gif src="https://media.giphy.com/media/cIWnDtConYRFPxmmah/giphy.mp4" caption="David Rose is getting organized." />
...
![Homepage for MERN app with CRUD functionality](https://res.cloudinary.com/dcrgbfjfu/image/upload/v1644109224/iamtimsmith/homepage_vlwguq.png "Homepage for MERN app with CRUD functionality")
