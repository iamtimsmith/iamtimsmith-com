...
excerpt: >-
  Today I'm going to show you how you can use variables and logic in your
  templates to make them dynamic and flexible to allow you to display data
  however you need.
published: true
feauredImage: >-
  https://res.cloudinary.com/dcrgbfjfu/image/upload/v1644109220/iamtimsmith/using-the-pug-templating-engine-part-2-logic_ngbh0q.jpg
---
...
<gif src="https://media.giphy.com/media/cfUMNY4RfGhEc/giphy.mp4" caption="A surprised-looking pug." width={300} />
...
Have questions? You can reach me on Twitter [@iam\_timsmith](https://www.twitter.com/iam_timsmith).
